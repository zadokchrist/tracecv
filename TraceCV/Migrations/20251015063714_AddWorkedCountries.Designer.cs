...
namespace TraceCV.Migrations
{
    ...
    [Migration("20251015063714_AddWorkedCountries")]
    partial class AddWorkedCountries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TraceCV.Models.WorkedCountry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TraceCV.Models.WorkedCountry", b =>
                {
                    b.HasOne("TraceCV.Models.Expert", null)
                        .WithMany("AfricanCountriesWorked")
                        .HasForeignKey("ExpertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TraceCV.Models.Expert", b =>
                {
                    ...
                    b.Navigation("AfricanCountriesWorked");
